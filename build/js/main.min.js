...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var hiddenText = document.querySelector('.about__hidden-text');
  var anchor = document.querySelector('a[href="#feedback"]');
  var mediaQuery = window.matchMedia('(max-width: 767px)');
  var consultButton = document.querySelector('.intro__link');
  var hiddenMobileText = document.querySelector('.about__hidden-mobile-text');
  var productsTitle = document.querySelector('.products__title');
  var accordionTitles = document.querySelectorAll('.accordion__title');
  var modalButton = document.querySelector('.header-nav__button');
  var modal = document.querySelector('.modal');
  var modalOverlay = modal.querySelector('.modal__overlay');
  var closeButton = modal.querySelector('.modal__close-btn');
  var focusedInput = modal.querySelector('input[type="text"]');
  var accordion = document.querySelector('.accordion');
  var submitButton = document.querySelector('.form button[type="submit"]');
  var modalSubmitButton = document.querySelector('.modal button[type="submit"]');
  accordion.classList.remove('accordion--no-js');
  Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])();
  if (accordionTitles) {
    accordionTitles.forEach(function (title, i) {
      title.addEventListener('click', function () {
        title.classList.toggle('active');
        var height = title.nextElementSibling.scrollHeight;
        console.log(height);
        if (title.classList.contains('active')) {
          title.nextElementSibling.style.height = "".concat(height, "px");
  ...
  var inputTel = document.querySelector('.form__inputs input[type="tel"]');
  var modalTel = document.querySelector('.form__inputs--modal input[type="tel"]');
  console.log(inputTel);
  var maskOptions = {
    mask: '+{7}(000)000-00-00'
  };
  var feedbackMask = Object(imask__WEBPACK_IMPORTED_MODULE_2__["default"])(inputTel, maskOptions);
  var modalMask = Object(imask__WEBPACK_IMPORTED_MODULE_2__["default"])(modalTel, maskOptions);
  var message = 'Введите корректный номер телефона';
